...
<link rel="stylesheet" type="text/css" href = "<?php echo base_url(); ?>myassets/styles/ezimba_products.css">
<link rel="stylesheet" type="text/css" href = "<?php echo base_url(); ?>myassets/styles/categories_responsive.css">
</head>
<body>
...
?>
    ...
    <div class="product">
    	<div class="product_image"><img class='card_img' src='<?=$dd?>' alt='Photo2'/></div>
    ...
    padding: 5px;
    cursor: pointer;
    transform: rotateZ(45deg);">ADD TO CART</button>
    		</div>
...
<script type = 'text/javascript' src = "<?php echo base_url(); ?>myassets/js/categories.js"></script>
</body>
</html>