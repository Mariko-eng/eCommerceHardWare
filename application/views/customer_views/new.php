...
<link rel="stylesheet" type="text/css" href = "<?php echo base_url(); ?>myassets/styles/ezimba_home_css.css">
<link rel="stylesheet" type="text/css" href = "<?php echo base_url(); ?>myassets/styles/responsive.css">
</head>
<body>
...
?>
							<div class="logo"><a href="<?=$homelink?>">...eZimba#ardWare</a></div>							<nav class="main_nav">
								<ul>
									...
									<li><a href="#list_of_services">Services Offered</a></li>
<?php
		...
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(<?php echo base_url('myassets/images/work.png'); ?>)"></div>
								...
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										...
										<div class="button button_light home_button">
											<a href="<?php echo base_url('ezimba/allproducts'); ?>">Shop Now</a>
										</div>
									</div>
								</div>
							</div>
...
?>
    <div class="product">
    	<div class="product_image" style="width: 270px; height: 250px; padding: 15px;
    	margin-bottom: 15px;"><img class='card_img' style="width:inherit;height: inherit;"
    		src='<?=$dd?>' alt='Photo2'/>
    	</div>
    	<div class ="product_spec" style="display: flex;flex-direction: row; justify-content: space-around;
    	align-items: center;">
    		<div class="product_ext" style="display: flex;flex-direction: column;">
    			<div><a href="<?=$alink?>">
					<?=$k->name?>
					</a></div>
    			<div><?=$k->price?> UgShs</div>
    		</div>
    ...
    padding: 5px;
    cursor: pointer;
    transform: rotateZ(45deg);">ADD TO CART
				</button>
    		</div>
    		<div class="productID" style="display: none"><?=$k->product_id?></div>
    	</div>
	</div>
		...
		<div class="container">
			<div class="row icon_box_row">
				...
				<div class="col-lg-3 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="<?php echo base_url('myassets/images/icon_1.svg'); ?>" alt=""></div>
				...
				<div class="col-lg-3 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="<?php echo base_url('myassets/images/icon_2.svg'); ?>" alt=""></div>
				...
				<div class="col-lg-3 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="<?php echo base_url('myassets/images/icon_3.svg'); ?>" alt=""></div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('.product > .product_spec > .product_cart').find('button').click(function(){
			...
			$.ajax({
				...
				success : function(response){
					...
					$('.cartNo').text("Cart (" + response.no_of_cartItems + ")");
				}
			});
		});
	});
...
<script type = 'text/javascript' src = "<?php echo base_url(); ?>myassets/js/custom.js"></script>
</body>
</html>